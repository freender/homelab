...
Before any reboot, use the question tool (`AskUserQuestion` under Claude Code) to
show the exact nodes, guests affected,
...
that rebooting bray kills this agent session and empties the shared SSH agent; execute the reboot
